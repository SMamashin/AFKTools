...
script_properties('work-in-pause') -- кто прочитал у того порвутся трусы
	...
	if afksets.v then
		...
		elseif menunum == 5 then
			...
			elseif imgui.CollapsingHeader(u8'v3.0 (Глобальное обновление, TG Notifications, кастомизация и др.)') then
				...
				imgui.Separator()
			elseif imgui.CollapsingHeader(u8'v3.1-v3.3 (Исправления ошибок, долгая пауза, новые функции)') then
